...
Fe55ElectronMult = ConfigData["Fe55ElectronMult"]
Fe55HoleMult = ConfigData["Fe55HoleMult"]
...
file.close()
figure()
suptitle("Fe55 spot, %d spots, Fe55ElectronMult = %.1f, Fe55HoleMult = %.1f"%(NumSpots,Fe55ElectronMult,Fe55HoleMult))
subplot(1,2,1)
title("X-Slice")
